...
export declare type QueryValue = string | number | boolean | null;
export declare type Query = Record<string, QueryValue>;
...
export declare type WagaNext = () => void;
export declare type ValidMethods = 'GET' | 'POST' | 'PUT' | 'DELETE' | 'USE';
export declare type WagaHandlerCallback = (req: WagaRequest, res: WagaResponse, next: WagaNext) => void;
